...
const reviews = [
  ...
  },
  {
    name: "Мистер Макс",
    role: "Детский блогер",
    text: "Привееееет ребята! Сегодня я попробовал новый искусственный интеллект под названием MerdeGPT и это ОЧЕНЬ КРУТО!! Он помог мне придумать новую игру для видоса. Мама сказала что получилось даже лучше чем мои мультики. Подписывайтесь на MerdeGPT, ставьте лайк, всем пока!",
    rating: 5,
  },
  {
    name: "Инстасамка",
